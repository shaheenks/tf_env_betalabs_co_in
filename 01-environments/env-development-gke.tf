module "playground-gke-project" {
  source="terraform-google-modules/project-factory/google"
  version = "~> 12.0"

  name="playground-gke-env01"
...
module "playground-gke-project-iam" {
  source   = "terraform-google-modules/iam/google//modules/projects_iam"
  projects = [ module.playground-gke-project.project_id ]
  mode     = "additive"
...
resource "google_monitoring_monitored_project" "playground-gke-project-monitoring" {
  metrics_scope="locations/global/metricScopes/${var.shared-services-project}"
  name="locations/global/metricScopes/${var.shared-services-project}/projects/${module.playground-gke-project.project_id}"
}
